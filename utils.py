...
def gumbel_softmax_sample(logits, tau=1, eps=1e-10, gpu_number=0):
    """
    NOTE: Stolen from https://github.com/pytorch/pytorch/pull/3341/commits/327fcfed4c44c62b208f750058d14d4dc1b9a9d3
...
def gumbel_softmax(logits, tau=1, hard=False, eps=1e-10, gpu_number=0):
    """
    NOTE: Stolen from https://github.com/pytorch/pytorch/pull/3341/commits/327fcfed4c44c62b208f750058d14d4dc1b9a9d3
    ...
    (MIT license)
    """
    y_soft = gumbel_softmax_sample(logits, tau=tau, eps=eps, gpu_number=gpu_number)
    if hard:
        shape = logits.size()
